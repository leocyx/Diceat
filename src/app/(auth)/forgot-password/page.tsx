    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-4 font-sans">
      <Card className="w-full max-w-md mx-auto shadow-2xl shadow-red-100 border-red-50">
        <CardHeader className="text-center pb-8">
          ...
          <CardTitle className="text-3xl font-black text-red-700">忘記密碼</CardTitle>
        ...
        <CardFooter className="flex justify-center py-8">
          <Link href="/login" className="flex items-center gap-2 text-sm text-red-700 font-bold hover:underline">
            <ChevronLeft size={16} />
            返回登入
          </Link>
        </CardFooter>
